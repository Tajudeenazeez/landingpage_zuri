        ...
        <div className="flex flex-col items-center relative">
          <div className="flex justify-center items-center w-3/4">
            <p className="text-[#3a2350] text-lg font-Graphik my-4 px-2 text-center">
              {" "}
              <strong>Notice:</strong>cohort II registration is closed, You can
              register to join the next cohort.
            </p>
          </div>
          <div>
            <img
              className="w-96 h-80 xl:absolute left-5 top-28"
              src={girl}
              alt="girl"
            />
          </div>
          ...
          <div>
            <img
              className="hidden  xl:block w-80 h-80 xl:absolute xl:right-5 xl:top-28 "
              src={boy}
              alt="boy"
            />
          </div>
